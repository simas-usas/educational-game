...
public class Box_04 : MonoBehaviour {
	...
	public void ButtonPressed () {
		...
		yBoxSize = screen.GetComponent<ProcessInformation_Level03> ().playerNumberY_03;
		...
		*/
		...
		if (screen.GetComponent<ProcessInformation_Level03>().boxHeight_03)
        {
