...
public class Box_01 : MonoBehaviour {
	...
	public void ButtonPressed () {
		...
		yBoxSize = screen.GetComponent<ProcessInformation_Level03> ().playerNumberY_00;
		...
		*/
		...
		if (screen.GetComponent<ProcessInformation_Level03>().boxHeight_00)
        {
