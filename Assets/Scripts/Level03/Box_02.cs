...
public class Box_02 : MonoBehaviour {
	...
	public void ButtonPressed () {
		...
		yBoxSize = screen.GetComponent<ProcessInformation_Level03> ().playerNumberY_01;
		...
		*/
		...
		if (screen.GetComponent<ProcessInformation_Level03>().boxHeight_01)
        {
			...
			yPos [1] = -26.61f + ((float)yBoxSize - 1f) * 7.6f;
